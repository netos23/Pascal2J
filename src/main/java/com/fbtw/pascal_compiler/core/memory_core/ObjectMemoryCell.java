...
public class ObjectMemoryCell extends MemoryCell {


    protected ObjectMemoryCell(ArrayList<DataPair<Integer[]>> names, ArrayList<Integer[]> lengths) {
        super(names, lengths);
    }
    ...
    public static class ObjectMemoryCellBuilder extends CellBuilder{
